--TEST--
call_user_func_array()/forward_static_call_array() override call_user_func_array called.
--INI--
callmap.override_call_user_func_array=1
callmap.override_forward_static_call_array=0
--FILE--
<?php
