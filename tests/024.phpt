--TEST--
call_user_func_array()/forward_static_call_array() override forward_static_call_array called.
--INI--
callmap.override_call_user_func_array=0
callmap.override_forward_static_call_array=1
--FILE--
<?php
